    ...
    <article className="relative">
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p className="leading-relaxed text-muted-foreground">
            As the new kingdoms took shape, several leaders emerged: <b>DSK_Sayan</b> became the leader of France, <b>Kanzo</b> claimed Spain, and <b>Acht</b> secured the Roman Empire. Amid this political reshuffling, four principal figures came to prominence in the Netherlands: the Queen with striking silver hair and blazing red eyes who possessed both compassion for her people and cold strategic calculation, an advisor, the Queen's daughter, and <b>Don von Craft</b>, the royal historian and advisor to King Manji the Great.
          </p>
