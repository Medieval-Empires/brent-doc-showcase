...
const Index = () => {
  ...
  const renderArticle = () => {
    switch (selectedArticle) {
      ...
      case "article-igc":
        return <IGCArticle onClose={() => setSelectedArticle(null)} onNavigate={handleNavigateToArticle} />;
      case "article-league":
        return <LeagueArticle onClose={() => setSelectedArticle(null)} onNavigate={handleNavigateToArticle} />;
      case "article-brent":
